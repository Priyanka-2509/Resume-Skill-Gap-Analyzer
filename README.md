...
The application supports both PDF and text-based resumes and is designed to be modular, transparent, and extensible.
...
https://resume-skillgap-dss.streamlit.app/

---

📊 Problem Statement  

Resume screening is often time-consuming and subjective. Candidates apply for roles without clear visibility into required skills, while recruiters manually evaluate large volumes of resumes.

This project addresses the problem by automating resume–job matching using rule-based logic while maintaining full explainability of results.
...
• Extracting skills using a predefined skill taxonomy  
...
git clone https://github.com/Priyanka-2509/Resume-Skill-Gap-Analyzer.git  
...
• Support for non-technical skill domains  
